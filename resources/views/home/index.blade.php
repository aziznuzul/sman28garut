        ...
        <div class="row h-100 align-items-center">
            <div class="col-12">
                ...
                <div class="hero-content text-center">
                    <h2>Selamat Datang di SMAN 28 Garut</h2>
                    <a href="{{ route('about') }}" class="btn clever-btn">Tentang Kami</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="regular-page-area section-padding-100 mt-5 mb-4">
    <div class="col-lg-9 mx-auto">
        <div class="card">
            <div class="card-header">SMAN 28 Garut</div>
            <div class="card-body">
                <p class="lead">
                    Alamat : Jl. Letjen S. Parman Purbayani-Caringin Garut
                </p>
            </div>
        </div>
    </div>
